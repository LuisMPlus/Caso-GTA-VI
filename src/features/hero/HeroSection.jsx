...
const HeroSection = () => {
  ...
  return (
    <section
      id="hero"
      className="relative overflow-hidden bg-gradient-to-br from-gray-900 via-gray-800 to-black pt-20 min-h-screen"
    >
          ...
          <motion.div variants={itemVariants} className="flex justify-center">
            <div className="p-6 border border-red-500/50 rounded-xl bg-red-900/20 max-w-3xl mx-auto text-center">
              ...
              <p className="text-base text-gray-300 leading-relaxed">
                Este sitio contiene información sobre el análisis del incidente
                de seguridad de GTA VI
                <br />
                <br />
